...
public class NoticeFragment extends Fragment {
    ...
    private ArrayList<NoticeData> list; //initialize when we get data in snapshot
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //here didn't initialize list  because deleted notice will show here and also show remaing notices
