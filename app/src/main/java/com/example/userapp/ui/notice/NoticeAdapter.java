...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, final int position) {
        ...
        holder.showNoticeTittle.setText(currentItem.getTittle());
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        private TextView showNoticeTittle, date, time;
        private ImageView showNoticeImage;

        //constructor
        public NoticeViewAdapter(@NonNull View itemView) {
            super(itemView);
            showNoticeTittle = itemView.findViewById(R.id.showNoticeTittle);
