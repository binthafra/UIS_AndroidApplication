...
public class GalleryFragment extends Fragment {
    ...
    RecyclerView  convoRecyclerView, techFestRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        techFestRecyclerView =view.findViewById(R.id.techFestRecyclerView);
    ...
    private void getTechFestImage() {
        databaseReference.child("Tech Fest").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                techFestRecyclerView.setLayoutManager(new GridLayoutManager(getContext(),3));
                techFestRecyclerView.setAdapter(adapter);
            }
